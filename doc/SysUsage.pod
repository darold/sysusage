...
need the GD and GD::Graph3D Perl modules. Note that the use of GD and GD::Graph
...
=head2 sysusagegraph (deprecated) / sysusagejqgraph
...
must be used, see result of command: sar -m ALL 1 1
